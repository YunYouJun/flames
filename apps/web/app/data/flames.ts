...
const visualBriefs = {
  ...
  goldenEmperor: {
    ...
    interpretation: '将流金主焰收束为五尖焰冠，液态金纹从冠顶向下循环，外围以四道细窄裂痕表现空间被高温侵蚀。',
    silhouette: '五尖金色焰冠包围高耸主焰，冠体下宽上锐，空间裂痕分布在两侧而不形成实体武器。',
    palette: '炽白金核、明亮鎏金内焰、赤金外缘与深褐空间裂隙。',
    motion: '流金纹理持续自上而下回流，焰冠本体稳定抬升；裂痕以低频闪断方式出现。',
    interactions: {
      pointer: '主焰与冠心向指针偏转，近侧裂痕提前亮起。',
      hold: '五尖焰冠抬高，空间裂痕向外延伸。',
      drag: '液金纹横向剪切，裂痕沿拖拽方向产生错位。',
    },
    fallback: '以五尖鎏金焰冠、液态金纹和四道空间裂痕保持识别。',
    differentiation: '流金冠冕与空间裂痕共同构成高阶压迫感，不依赖普通金色焰柱。',
    specialPasses: [],
    reviewScenes,
  },
  eightDesolation: {
...
const roster = [
  ...
  },
  {
    ...
    visual: prototypeVisual('crown', visualBriefs.goldenEmperor, {
      ...
      palette: { core: '#fffbd5', inner: '#ffbf32', outer: '#5f2800' },
      speed: 0.86,
      scale: 0.94,
      turbulence: 0.92,
      intensity: 1.12,

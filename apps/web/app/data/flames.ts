...
const visualBriefs = {
  ...
  goldenEmperor: {
    ...
    interpretation: '以七重流金火苗直接构成冠形：中央高焰与六道侧焰持续卷曲、分裂再合拢，低位熔金火池不断补充焰身；日轮退到后景，仅用十二道威光压住空间。',
    silhouette: '七道高低错落的金色火苗从宽阔熔金底座升起，中央焰最高，两侧逐级降低形成火冠；日轮只作为后景，不再取代真实焰体。',
    palette: '浅金焰心、纯金内焰与深金外焰，整条温度色带均属于金色，不使用白核或暗褐主体。',
    motion: '两层噪声域持续向上推进，七道火苗以不同生命周期快速上卷、断裂与再生；亮部采用加法辉光，暗边随热度消隐，日轮则保持较慢转动。',
    interactions: {
      pointer: '主焰与冠心向指针偏转，近侧裂痕提前亮起。',
      hold: '七重火苗同时抬高，熔金底座外扩，空间裂痕向外延伸。',
...
const roster = [
  ...
  },
  {
    ...
    visual: prototypeVisual('crown', visualBriefs.goldenEmperor, {
      ...
      palette: { core: '#fff2a6', inner: '#ffd000', outer: '#b97800' },
      speed: 1.24,
      scale: 1,
      turbulence: 1.02,
      intensity: 1.42,

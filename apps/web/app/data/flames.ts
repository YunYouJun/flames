...
const visualBriefs = {
  ...
  windFuryDragon: {
    ...
    interpretation: '以一条青灰风龙沿螺旋上升，龙首在高位迎风凝聚，外围两道高速风轨交叉掠过。',
    silhouette: '细长螺旋龙身贯穿纵向空间，顶部形成带双角的龙首，外围保留两道横向风轨。',
    palette: '冷白龙目、青灰风鳞、深蓝黑外风与少量风刃高光。',
    motion: '龙身沿螺旋节奏上行，鳞光逐段闪烁；外轨速度高于龙身，形成包裹式风暴。',
    interactions: {
      pointer: '龙首与上段龙身朝指针方向追随。',
      hold: '龙首抬高、双角点亮，外轨半径扩大。',
      drag: '螺旋龙身加剧摆动，两道外轨产生反向旋切。',
    },
    fallback: '以青灰螺旋龙身、双角龙首和交叉风轨保持扩展身份。',
  ...
  goldenEmperor: {
    ...
    interpretation: '以稳定对称的五峰鎏金冠托起白金主焰，背后展开完整天幕日轮与十二道威光；液态金纹自冠顶回流，两道对称金色空间裂痕在远侧开合。',
    silhouette: '宽阔五峰鎏金冠包围高耸主焰，完整日轮从冠后升起，十二道短促威光把主体扩展成庄严对称的帝王轮廓。',
    palette: '炽白金核、明黄鎏金主体、赤金外缘与琥珀空间裂隙，避免大面积暗褐吞掉金光。',
    motion: '冠冕与日轮保持低速稳定，流金纹理持续自上而下回流；十二颗冠珠依次闪耀，裂痕以低频开合。',
    interactions: {
      pointer: '主焰与冠心向指针偏转，近侧裂痕提前亮起。',
      hold: '五尖焰冠抬高，空间裂痕向外延伸。',
      drag: '液金纹横向剪切，裂痕沿拖拽方向产生错位。',
    },
    fallback: '以五峰鎏金冠、白金主焰、完整日轮和十二道威光保持帝王识别。',
    differentiation: '稳定对称的天幕冠轮与流金瀑共同构成威严，区别于帝炎的多色万火归一，也不再像普通尖冠金焰。',
    specialPasses: [],
    reviewScenes,
  },
  eightDesolation: {
    facts: ['淡黑色异火可铺展为巨大火翼，并卷起猛烈的火焰风暴。'],
    interpretation: '让中央主焰退居次位，以左右展开的淡黑宽翼占据画面；五层风暴火带穿过翼下，形成向两侧撕裂的破灭感。',
    silhouette: '一对横向展开的巨大火翼包围窄小焰心，翼尖下压，翼下多层风暴带彼此错动。',
    palette: '灰白风暴高光、淡黑火翼、深灰紫外缘与低亮中央焰心。',
    motion: '双翼缓慢拍动，翼纹以波浪传播；翼下风暴带高速横穿，速度远高于中央焰心。',
    interactions: {
      pointer: '双翼迎着指针方向产生不对称倾角。',
      hold: '翼展扩大，翼下五层风暴带同时加速。',
      drag: '左右火翼反向扭曲，风暴带被撕成错相层。',
    },
    fallback: '以淡黑巨大双翼、中央小焰心和五层横向风暴带保持识别。',
    differentiation: '画面主体是横向双翼而非龙、莲或圆环，且风暴只作为翼下次级结构。',
    specialPasses: [],
    reviewScenes,
  },
  netherGolden: {
    facts: ['原著明确名称、榜位、持有者和融合关系，但没有可靠细述独立颜色、形态或能力。'],
    interpretation: '仅从名称做克制的项目演绎：以沉凝暗金祖焰构成碑状火印，内部金纹像古老铭文缓慢游走，不扩写独立权能。',
    silhouette: '窄长暗金焰碑居中，肩部外扩，顶部形成短冠，外围一圈断续祖纹火环。',
    palette: '暗白纹心、沉金主体、乌金外缘与低亮褐黑背景。',
    motion: '主体几乎静止，内部祖纹从下向上缓慢迁移；外围火环间歇分段点亮。',
    interactions: {
      pointer: '碑状火印轻微偏转，近侧祖纹提前显现。',
      hold: '顶部短冠升起，外围祖纹环向外扩张。',
      drag: '内部铭纹沿拖拽方向倾斜，主体保持沉稳。',
    },
    fallback: '以暗金焰碑、顶部短冠和断续祖纹环保持项目演绎轮廓。',
    differentiation: '沉凝碑印区别于金帝焚天炎的流动金冠，并明确形态属于项目演绎。',
    specialPasses: [],
    reviewScenes,
  },
  emperor: {
...
const roster = [
  ...
  },
  {
    ...
    visual: prototypeVisual('crown', visualBriefs.goldenEmperor, {
      ...
      palette: { core: '#fffef0', inner: '#ffd43b', outer: '#c76a00' },
      speed: 0.72,
      scale: 1.04,
      turbulence: 0.68,
      intensity: 1.34,
  ...
  },
  {
    ...
    visual: prototypeVisual('crown', visualBriefs.netherGolden, {
      ...
      palette: { core: '#fff0a3', inner: '#a87922', outer: '#21170c' },
      speed: 0.54,
      scale: 0.86,
      turbulence: 0.62,
      intensity: 0.92,
  ...
  },
  {
    ...
    visual: prototypeVisual('gale', visualBriefs.windFuryDragon, {
      ...
      palette: { core: '#e6fff8', inner: '#43b9b1', outer: '#102b38' },
      speed: 1.18,
      scale: 0.96,
      turbulence: 1.32,
      intensity: 1.02,

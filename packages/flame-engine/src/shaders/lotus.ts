...
export const lotusFragmentShader = /* glsl */ `
  ...
  void main() {
    ...
    vec3 plume = plumeLayers(flowingPoint, clock, mix(0.92, 1.08, karmic) + uPressed * 0.08, mix(0.030, 0.038, karmic));
    ...
    float mask = max(max(livingBody, petalMask), ritualMask * karmic);
